document.addEventListener('DOMContentLoaded', () => {
    ...
    if (recommendForm) {
        recommendForm.addEventListener('submit', async (e) => {
            ...
            submitBtn.textContent = 'Analyzing Rules...';
            ...
            try {
                const response = await fetch('/api/recommend', {
                    ...
                    body: JSON.stringify({ diet, cuisine, taste, calories })
                });
            ...
            try {
                ...
                recipes.forEach(recipe => {
                    ...
                    row.innerHTML = `
                        ...
                        <td><span style="color: var(--accent-amber); font-weight: 600;">${recipe.calories} kcal</span></td>
                ...
                console.error(error);
                adminTableBody.innerHTML = `<tr><td colspan="6" style="text-align: center; color: var(--danger-red);">Error loading database.</td></tr>`;
            }
        };
            ...
            <div class="recipe-content">
                <div>
                    ...
                    <div class="recipe-meta">
                        ...
                        <span class="meta-badge">Calories: <strong style="color: var(--accent-amber);">${recipe.calories} kcal</strong></span>
                        <span class="meta-badge">Taste: <strong>${escapeHtml(recipe.taste)}</strong></span>
                    </div>
                </div>
                
                <div class="scientific-box" style="margin-bottom: 1rem;">
